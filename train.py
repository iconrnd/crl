...
# Selecting one GPU for training
...
def main():
  ...
  while step < config.steps:
    ...
    eval_driver(eval_policy, episodes=config.eval_eps, log_x_out=False, loop=loop)
    print('Start training.')
    train_driver(train_policy, steps=config.eval_every, log_x_out=True, loop=loop, reporting_step=step)
